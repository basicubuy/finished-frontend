<?php require_once 'inc/home-header.php'; ?>
    <main class="overflow-hidden">
        <section  class="bg-white">
            <div class="max-w-7xl mx-auto py-20 w-full">
                 <div class="w-full rounded-llg state-detail-hero px-8 py-16 xl:py-44 xl:px-24 text-white relative flex flex-col justify-center items-center bg-center bg-no-repeat bg-cover" style="background-image: url('../../assets/images/careers-hero.jpeg');">
                ...
                <p class="text-center px-1 mb-14 text-sm">
                    There is nothing more frustrating than scouring the streets and endless internet searches for someone to help you complete your task. From big cities to small towns, we’ve got pros covering every local government area in Abuja
                </p>
        ...
        <section class="w-full bg-white">
            <div class="wrapper mx-auto">
                <h1 class="text-left text-32 font-semibold mb-6">
                    Popular Professional Services in Abuja
                </h1>

                <div class="flex flex-row items-center justify-between relative w-full category-slider">
                    <div class="splide__track min-w-ttft">
                        <div class="w-full flex flex-row items-center gap-x-5 flex-auto mx-auto splide__list">
                            <div class="splide__slide">
                                <div class="splide__slide__container h-60 bg-no-repeat bg-cover bg-center category-item relative flex items-start justify-end flex-col px-5 py-7 text-white"
                                    style="background-image: url('../../assets/images/dj-service.png');">
                                    <h1 class="text-2xl font-semibold">DJ Service</h1>
                                    <div class="flex flex-row items-center">
                                        <span class="text-sm font-medium mr-2">See Pros near you</span>
                                        <span>
                            ...
                            <div class="splide__slide">
                                <div class="splide__slide__container h-60 bg-no-repeat bg-cover bg-center category-item relative flex items-start justify-end flex-col px-5 py-7 text-white"
                                    style="background-image: url('../../assets/images/design.png');">
                                    <h1 class="text-2xl font-semibold">Design</h1>
                                    <div class="flex flex-row items-center">
                                        <span class="text-sm font-medium mr-2">See Pros near you</span>
                                        <span>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <div class="splide__slide">
                                <div class="splide__slide__container h-60 bg-no-repeat bg-cover bg-center category-item relative flex items-start justify-end flex-col px-5 py-7 text-white"
                                    style="background-image: url('../../assets/images/photography.png');">
                                    <h1 class="text-2xl font-semibold">Photography</h1>
                                    <div class="flex flex-row items-center">
                                        <span class="text-sm font-medium mr-2">See Pros near you</span>
                                        <span>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <div class="splide__slide">
                                <div class="splide__slide__container  h-60 bg-no-repeat bg-cover bg-center category-item relative flex items-start justify-end flex-col px-5 py-7 text-white"
                                    style="background-image: url('../../assets/images/event.png');">
                ...
                <div class="flex flex-row items-center text-lg font-medium justify-center mt-10">
                    <span>Don’t see what you’re looking for? </span>
                    <a href="/" class="text-ubuy-blue ml-1">See all categories</a>
                </div>
            </div>
        </section>
            ...
            <div class="wrapper mx-auto">
                <div class="mb-10 text-center max-w-3xl mx-auto">
                    <h1 class="text-32 font-semibold text-ubuy-dark mb-2.5">
                        Top Rated Professionals in Abuja
                    </h1>
                    <p class="text-sm text-ubuy-secondary text-center ">
                ...
                <div class="my-10 flex flow-row items-center justify-center">
                    <a href="" class="text-center text-ubuy-blue">See all House Cleaners in Abuja</a>
                </div>
            </div>
        </section>

        <section class="w-full py-14 bg-white">
            <div class="wrapper mx-auto flex lg:flex-row flex-col-reverse w-full">
                <div class="flex flex-col items-center justify-center lg:w-1/2 w-full relative state-pitch lg:mr-6 lg:mb-0 mb-8 z-10">
                    <img src="../../assets/images/pitch-state.jpeg" alt="" class="img-state-pitch min-w-full h-auto" />
                </div>
                <div class="flex flex-col items-center justify-center lg:w-1/2 w-full">
                    <h1 class="text-ubuy-black lg:text-32 md:text-lg text-base text-center lg:text-left mb-5">
                        How To Hire Professional Services Around Me
                    </h1>
                    <p class="md:text-left text-center lg:text-sm text-xs text-ubuy-secondary">
                        Sign up as a customer if you are not signed up yet. Post task from your dashboard. Be sure to give a detailed description of what you want to be done. Vet bids and choose a service category that suits your task needs. Negotiate in-app with the Professional. Pay negotiated
                        amount into your U-pay account. When the job is done, the Service Professional receives payment. Connect with a Service Professional anywhere in Nigeria here
                    </p>
                </div>
            </div>
        </section>

        <section class="w-full bg-no-repeat bg-cover bg-left bg-white" style="background-image: url('../../assets/images/bottom-section-bg.png');">
            <div class="wrapper mx-auto">
                <div class="flex flex-col items-center justify-center py-16">
                    <h1 class="text-2xl text-ubuy-black font-medium text-center mb-5">
                        Ready to hire any of our skilled professionals ?
                    </h1>
        ...
        <section class="pb-10 bg-white">
            <div class="pt-6 wrapper mx-auto flex flex-col">
                <div class="w-full mb-12">
                    <h1 class="text-32 font-semibold text-ubuy-black text-center mb-2.5">Get Started</h1>
                    <h2 class="text-lg text-ubuy-secondary text-center">Find the best Professional service for your job now</h2>
                </div>
                <div class="flex md:flex-row flex-col items-stretch">
                    <div class="shadow-hw bg-white flex flex-col items-start sm:w-1/3 w-full p-7 rounded-20">
                        <div class="h-20 flex flex-row items-center justify-start mb-6">
