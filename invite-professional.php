...
$invite_prof = isset($invite_pro['pros']) ? $invite_pro['pros']: "";
$subCategory = $invite_pro['subCategory'];
?>
        ...
        <main class="flex-1 overflow-auto sm:pt-24 pt-20 flex items-stretch md:pl-64 pl-0 max-w-full">
            <div class="relative min-w-0 max-w-full w-full bg-ubuy-gray-400 h-full">
                <div class="flex w-full flex-col lg:my-7 my-4 lg:pl-7 lg:pr-10 px-4 gap-y-6">
                    ...
                    <!-- Pro List Mobile -->
                    <!-- Pro List Mobile -->
                    <div class="sm:hidden flex flex-col w-full gap-y-4">


                        <?php

                        foreach($invite_pro  as $item){ ?>



                        <div class="flex flex-row gap-x-3 p-5 relative items-center text-ubuy-secondary bg-white rounded-llg">
                            <div>
                                <img src="<?php echo $invite_prof['public_url'] != 'http://new.ubuy.ng/storage' ? $invite_prof['public_url'] : 'assets/images/ubuy_logo.svg'; ?>" alt="avatar" class="" />
                            </div>
                            <div class="flex flex-col">
                                ...
                                <div class="self-end ">
                                    <button onclick="onOpenPopup('invite-pro-mobile')" class="text-xs bg-ubuy-blue rounded shadow-card text-white text-tiny py-1 px-2">Invite to task</button>
                                </div>
                            </div>
                    ...
                    <div class="hidden sm:inline-grid grid-flow-row grid-cols-2 xl:grid-cols-3 gap-6 place-items-center">
                        ...
                        foreach($invite_prof  as $item){ ?>

                        <div class="flex flex-col items-center px-5 pt-5 bg-white rounded-llg pb-6 max-w-sm w-full">
                            <img src="<?php echo $item['public_url'] != 'http://new.ubuy.ng/storage' ? $item['public_url'] : 'assets/images/ubuy_logo.svg'; ?>" alt="avatar" class="rounded-full w-32 h-32" />
                            <div class="flex flex-row items-center">
                                <span><?php echo ucfirst($item['last_name']) .' '.ucfirst($item['first_name'][0]); ?>.</span>
                                <?php echo $item['verify_confirm'] == 3 ? '<span>
                            ...
                            <div class="flex flex-row items-center justify-center w-full">
                                ...
                                <div id="profile-rating" class="flex flex-col px-4 relative">
                                    <div class="text-xs text-ubuy-secondary flex flex-row items-center justify-center">
                                        <span><?php echo $item['average_rating']; ?></span>
                                        <span>
                                    ...
                                    <span class="text-tiny text-ubuy-inactive"><?php echo $item['rating']; ?> Ratings</span>
                                </div>
                                <div class="flex flex-col justify-center items-center ml-4">
                                    <span class="text-xs text-ubuy-secondary"><?php echo date('M. Y', strtotime($item['created_at']));; ?></span>
                                    <span class="text-tiny text-ubuy-inactive">Date Joined</span>
                                </div>
                            </div>
                            <div class="flex flex-row w-full justify-between my-3">
                                <div class="flex flex-row items-center justify-center">
                                    <?php echo $item['verify_confirm'] == 3 ? '<span class="mr-2">
                                        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M9.16683 4.61677V5.00011C9.16632 5.89862 8.87537 6.77289 8.33738 7.49253C7.7994 8.21218 7.0432 8.73864 6.18156 8.9934C5.31993 9.24816 4.39902 9.21757 3.55619 8.90618C2.71336 8.5948 1.99377 8.01931 1.50473 7.26555C1.01569 6.51179 0.783409 5.62013 0.842528 4.72357C0.901647 3.82701 1.249 2.97358 1.83278 2.29055C2.41656 1.60753 3.20549 1.13152 4.08191 0.9335C4.95833 0.735485 5.87527 0.82608 6.696 1.19177"
                                                stroke="#2AC769" stroke-linecap="round" stroke-linejoin="round" />
                                    ...
                                    </span>' : '<img src="assets/images/cancel.svg" width="8" height="8" class="mr-2" />'; ?>
                                    <span class="text-tinyer"> Identity Verified</span>
                                </div>
                                <div class="flex flex-row items-center justify-center">
                                    <span class="mr-2">
                                        <?php echo $item['is_phone_verified'] == 1 ? '<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M9.16683 4.61677V5.00011C9.16632 5.89862 8.87537 6.77289 8.33738 7.49253C7.7994 8.21218 7.0432 8.73864 6.18156 8.9934C5.31993 9.24816 4.39902 9.21757 3.55619 8.90618C2.71336 8.5948 1.99377 8.01931 1.50473 7.26555C1.01569 6.51179 0.783409 5.62013 0.842528 4.72357C0.901647 3.82701 1.249 2.97358 1.83278 2.29055C2.41656 1.60753 3.20549 1.13152 4.08191 0.9335C4.95833 0.735485 5.87527 0.82608 6.696 1.19177"
                                                stroke="#119AE2" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M9.16667 1.6665L5 5.83734L3.75 4.58734" stroke="#119AE2" stroke-linecap="round" stroke-linejoin="round" />
                                ...
                                <div class="flex flex-row items-center justify-center">
                                    <span class="mr-2">
                                        <?php echo $item['email_verified_at'] != null ? '<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M9.16683 4.61677V5.00011C9.16632 5.89862 8.87537 6.77289 8.33738 7.49253C7.7994 8.21218 7.0432 8.73864 6.18156 8.9934C5.31993 9.24816 4.39902 9.21757 3.55619 8.90618C2.71336 8.5948 1.99377 8.01931 1.50473 7.26555C1.01569 6.51179 0.783409 5.62013 0.842528 4.72357C0.901647 3.82701 1.249 2.97358 1.83278 2.29055C2.41656 1.60753 3.20549 1.13152 4.08191 0.9335C4.95833 0.735485 5.87527 0.82608 6.696 1.19177"
                                                stroke="#F6A609" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M9.16667 1.6665L5 5.83734L3.75 4.58734" stroke="#F6A609" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <div class="my-3 flex flex-row justify-center items-center w-11/12 mx-auto">
                                <button onclick='onOpenPopupAttachTwo("invite-pro", "<?php echo ucfirst($item["first_name"])." ".ucfirst($item["last_name"][0])."~".ucfirst($subCategory["name"])."~0~".$item["average_rating"]."~".date("M Y", strtotime($item["created_at"]))."~".$item["id"]."~".$item["public_url"]."~".$_GET["project_id"]; ?>")' class="rounded-llg py-2 px-3 bg-ubuy-blue shadow-card text-xs text-white">Invite to Task</button>
                                <!-- <button onclick="onOpenPopup('invite-pro')" class="rounded-llg py-2 px-3 bg-ubuy-blue shadow-card text-xs text-white">Invite to Task</button> -->
                            </div>
                        </div>
        ...
        <div class="min-h-screen min-w-screen w-screen h-full hidden fixed place-items-center p-6" id="invite-pro" style="background-color: rgba(0, 0, 0, .5); z-index: 999999">
            <div class="ubuy-post-task-form-container flex flex-col items-center justify-around py-16 px-10 rounded-3xl shadow bg-white relative w-full max-w-xl">
                ...
                <div class="flex flex-col items-center justify-center mt-4 gap-y-2">
                    ...
                    <p class="text-sm text-ubuy-gray500 max-w-sm text-center">You are about to invite <span class="pro_name"></span> to review and bid on your task</p>
                </div>
